...
void init_styles(void) {
    ...
    lv_style_set_pad_all(&style_button, 2);
    lv_style_set_radius(&style_button, 3);
    lv_style_set_text_color(&style_button, lv_color_black());
    lv_style_set_text_font(&style_button, &lv_font_montserrat_14);

    lv_style_init(&style_button_active);
    lv_style_set_bg_color(&style_button_active, lv_color_black());
